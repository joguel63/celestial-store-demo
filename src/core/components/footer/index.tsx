  ...
  return (
    <Box component="footer" sx={styles.footer}>
      <Box sx={styles.grid}>
        ...
        <Box>
          ...
          <Box component="ul" sx={styles.linkList}>
            <li>
              <Link component={RouterLink} to={ROUTES.STABLES} underline="none" sx={styles.link}>
                {t('footer.navigation.stables')}
              </Link>
            </li>
            <li>
              <Link component={RouterLink} to={ROUTES.SUPPLIES} underline="none" sx={styles.link}>
                {t('footer.navigation.supplies')}
              </Link>
            </li>
            <li>
              <Link component={RouterLink} to={ROUTES.GUILD} underline="none" sx={styles.link}>
                {t('footer.navigation.guild')}
              </Link>
            </li>
          </Box>
        </Box>
        ...
        <Box>
          ...
          <Typography sx={styles.newsletterDesc}>{t('footer.newsletter.description')}</Typography>
      ...
      <Box sx={styles.bottom}>
        <Typography sx={styles.copyright}>{t('footer.copyright')}</Typography>
      </Box>
    </Box>
  )
}
